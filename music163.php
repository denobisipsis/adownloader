...
function getenseckey($key)
	{
	$js='<script>function RSAKeyPair(a, b, c) {
	    this.e = biFromHex(a),
	    this.d = biFromHex(b),
	    this.m = biFromHex(c),
	...
	enseckey=d("", "010001", "","");document.write(enseckey);</script>';
	
	$js=str_replace("key",$key,$js);
	
	return eval($js); // this is only informative
	}
