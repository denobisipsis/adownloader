...
function Vars(&$tb,&$mb,&$ub,&$kb,&$vb,&$Ya,&$wb,&$Ra,&$xb,&$Pa,&$yb,&$Na,&$zb,&$La,&$Ab,&$Ja,&$Bb,&$Ha,&$Cb,&$Ea,&$Db,&$ta,&$Eb,&$ra,&$Fb,&$pa,&$Gb,&$na,&$Hb,&$la,&$sb,&$p,&$Ib,&$n)
	{
	$tb=$mb;$ub=$kb;$vb=$Ya;$wb=$Ra;$xb=$Pa;$yb=$Na;$zb=$La;$Ab=$Ja;$Bb=$Ha;$Cb=$Ea;$Db=$ta;$Eb=$ra;$Fb=$pa;$Gb=$na;$Hb=$la;$sb=$p;$Ib=$n;
	}
		...
		if(($jb)>=608838580) 
			...
			if(($jb)>=801681189)
				...
				if(($jb)<974401706) 
						...
						if(($jb)<887924077)
								...
								if(($jb)<809617043) 
									{
									$this->Vars($tb,$mb,$ub,$kb,$vb,$Ya,$wb,$Ra,$xb,$Pa,$yb,$Na,$zb,$La,$Ab,$Ja,$Bb,$Ha,$Cb,$Ea,$Db,$ta,$Eb,$ra,$Fb,$pa,$Gb,$na,$Hb,$la,$sb,$p,$Ib,$n);
									$jb=($this->carr($RR,$n,$o>>2,"")|0)<64?-1361726950:1012403908;continue;
									}
					...
					if(($jb)<1093527402)
							if(($jb)<1058751639)
								...
								{
								$this->Vars($tb,$mb,$ub,$kb,$vb,$Ya,$wb,$Ra,$xb,$Pa,$yb,$Na,$zb,$La,$Ab,$Ja,$Bb,$Ha,$Cb,$Ea,$Db,$ta,$Eb,$ra,$Fb,$pa,$Gb,$na,$Hb,$la,$sb,$p,$Ib,$n);$jb=($this->carr($RR,$n,$o>>2,"")|0)<38?13290759:-526301530;
								continue;
								}					
			...
			if(($jb)<690197071)
					...
					if(($jb)<633810001)
						...
						if(($jb)<620960943)
							{
							$this->Vars($tb,$mb,$ub,$kb,$vb,$Ya,$wb,$Ra,$xb,$Pa,$yb,$Na,$zb,$La,$Ab,$Ja,$Bb,$Ha,$Cb,$Ea,$Db,$ta,$Eb,$ra,$Fb,$pa,$Gb,$na,$Hb,$la,$sb,$p,$Ib,$n);$jb=$this->aarr($RR,$n,$ea>>0,"")&1?1432877594:2028659015;continue;
							}
						else
							{
							$this->aarr($RR,$n,$dol>>0,($this->carr($RR,$n,$Fa>>2,"")|0)<8&1);
			...
			if(($jb)<-630729423)
					...
					if(($jb)<-668795440)
							if(($jb)<-671207445)
								...
								{
								$this->Vars($tb,$mb,$ub,$kb,$vb,$Ya,$wb,$Ra,$xb,$Pa,$yb,$Na,$zb,$La,$Ab,$Ja,$Bb,$Ha,$Cb,$Ea,$Db,$ta,$Eb,$ra,$Fb,$pa,$Gb,$na,$Hb,$la,$sb,$p,$Ib,$n);$jb=$this->aarr($RR,$n,$ca>>0,"")&1?-983205733:-1662327480;continue;
								}
							else
								{
								$tb=$this->carr($RR,$n,$__a>>2,"")|0;
							...
							if(($jb)<-80539691)
									...
									if(($jb)<-44538672)
											if(($jb)<-58343100)
												{
												$this->carr($RR,$n,$z>>2,($this->carr($RR,$n,$lb>>2,"")|0)+494575374+49-494575374);
												$this->Vars($tb,$mb,$ub,$kb,$vb,$Ya,$wb,$Ra,$xb,$Pa,$yb,$Na,$zb,$La,$Ab,$Ja,$Bb,$Ha,$Cb,$Ea,$Db,$ta,$Eb,$ra,$Fb,$pa,$Gb,$na,$Hb,$la,$sb,$p,$Ib,$n);$jb=484876086;continue;
												}
											else
												{
												$this->aarr($RR,$n,($this->carr($RR,$n,$J>>2,"")|0)+($this->carr($RR,$n,$za>>2,"")|0)>>0,$this->aarr($RR,$n,$g>>0,"")|0);
